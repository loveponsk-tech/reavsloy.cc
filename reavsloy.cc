...
TextButton.Font = Enum.Font.Gotham  -- Updated font here
TextButton.Text = "reavsloy.cc Off"
...
TextButton.MouseButton1Click:Connect(function()
    ...
    TextButton.Text = CamlockState and "reavsloy.cc On" or "reavsloy.cc Off"
